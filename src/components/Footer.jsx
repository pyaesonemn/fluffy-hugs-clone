...
const Footer = () => {
  return (
    <div className="z-[1000] w-full h-[100px] absolute bottom-0 left-0 flex flex-row items-center justify-between">
      <div className="px-4 md:px-10 flex flex-row items-center gap-x-4">
      ...
      <div className="hidden sm:flex text-white bg-indigo-900 w-[16rem] h-[10rem] rounded-[2rem] absolute bottom-0 right-[-40px] items-center justify-center">
        View collections
      </div>
    </div>
  );
